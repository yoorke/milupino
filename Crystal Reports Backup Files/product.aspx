    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 main-content product-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                ...
                <p>Pogledajte i ostale proizvode iz kategorije <a href="/proizvodi/laptop">Laptop</a></p>
                ...
                <div class="row priceBox color-gray">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <p class="font-2em color-blue bold margin-bottom-0"><asp:Literal ID="lblWebPrice" runat="server" Text="99.890 din"></asp:Literal></p>
                ...
                <div class="row icons">
                    ...
                    <div class="col-xs-3"><asp:LinkButton ID="btnCompare" runat="server" Text="Uporedi" OnClick="btnCompare_Click"></asp:LinkButton></div>
                    <div class="col-xs-1">
