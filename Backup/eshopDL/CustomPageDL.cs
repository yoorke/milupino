                ...
                using (SqlCommand objComm = new SqlCommand("getCustomPageByID", objConn))
                {
                    ...
                    using (SqlDataReader reader = objComm.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            customPage.InsertDate = reader.GetDateTime(5);
                            customPage.UpdateDate = reader.GetDateTime(6);
                ...
                using (SqlCommand objComm = new SqlCommand("customPageGetForCustomPageCategory", objConn))
                {
                    ...
                    using (SqlDataReader reader = objComm.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            customPage.InsertDate = reader.GetDateTime(7);
                            customPage.UpdateDate = reader.GetDateTime(8);
