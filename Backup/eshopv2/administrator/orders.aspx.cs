...
namespace eshopv2.administrator
{
    public partial class orders : System.Web.UI.Page
    {
        ...
        private void loadOrders()
        {
            ...
            dgvOrders.DataSource = orderBL.GetOrders(cmbStatus.SelectedIndex > 0 ? int.Parse(cmbStatus.SelectedValue) : -1, DateTime.Parse(txtDateFrom.Text), DateTime.Parse(txtDateTo.Text));
            dgvOrders.DataBind();
        }
