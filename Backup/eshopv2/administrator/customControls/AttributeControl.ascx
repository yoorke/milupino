<%@ Control ClassName="AttributeControl" Language="C#" AutoEventWireup="true" CodeBehind="AttributeControl.ascx.cs" Inherits="eshopv2.administrator.customControls.AttributeControl" %>
