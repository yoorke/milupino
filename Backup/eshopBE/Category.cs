...
namespace eshopBE
{
    public class Category
    {
        ...
        public Category(int categoryID, string name, int? parentCategoryID, string url, string imageUrl, int sortOrder, double pricePercent, double webPricePercent, string description)
        {
